...
LABEL io.nullables.sputnik.build-date=$BUILD_DATE
LABEL io.nullables.sputnik.name="Sputnik"
LABEL io.nullables.sputnik.description="Sputnik devbot platform"
LABEL io.nullables.sputnik.url="https://nullables.io/"
LABEL io.nullables.sputnik.vcs-ref=$VCS_REF
LABEL io.nullables.sputnik.vcs-url="https://github.com/AlexRogalskiy/sputnik"
LABEL io.nullables.sputnik.vendor="Nullables.io"
LABEL io.nullables.sputnik.version=$VERSION
